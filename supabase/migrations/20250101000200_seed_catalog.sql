...
('cut-buzz','Buzz cut','cut',
 ...
 'Give the person a buzz cut: uniform very short clipper cut of even length over the whole head, natural hairline. Keep the existing hair colour, and keep the beard exactly as it is.',
...
('cut-chauve','Crâne rasé','cut',
 ...
 'Shave the person completely bald: smooth clean scalp with no hair at all, natural skin tone and shine on the scalp. Keep the existing hair colour, and keep the beard exactly as it is.',
...
('cut-degrade-espagnol','Dégradé espagnol','cut',
 ...
 'Give the person a Spanish style fade haircut: skin fade on the sides and back, sharp defined line up at the temples and forehead, short textured top with a small straight fringe brought forward over the forehead. Keep the existing hair colour, and keep the beard exactly as it is.',
 '/demo/catalog/cut-degrade-espagnol.jpg', false, 30),

('cut-cuenca','Coupe cuenca','cut',
 array['court','raides','ondules','boucles','crepus','ovale','rond','carre','allonge','streetwear','remarque'],
 'Give the person a Spanish cuenca haircut: rounded bowl shaped cutting line following the top of the head, straight blunt fringe across the forehead, faded short sides and nape. Keep the existing hair colour, and keep the beard exactly as it is.',
...
('cut-middle-part','Middle part','cut',
 ...
 'Give the person a middle part hairstyle: hair of medium length parted straight down the centre, both sides falling symmetrically and framing the forehead, soft natural movement. Keep the existing hair colour, and keep the beard exactly as it is.',
...
('cut-lisse-cote','Lissé sur le côté','cut',
 ...
 'Give the person straight hair combed flat to one side: sleek smooth lengths with a clean side parting, no volume on top, tidy finish. Keep the existing hair colour, and keep the beard exactly as it is.',
...
('cut-afro-court','Afro court','cut',
 ...
 'Give the person a short afro: even short natural coily hair over the whole head with a sharp lined up hairline at the forehead and temples. Keep the existing hair colour, and keep the beard exactly as it is.',
...
('cut-afro-mi-long','Afro mi-long','cut',
 ...
 'Give the person a medium length afro: rounded voluminous natural coily hair standing out from the head, even shape, sharp lined up hairline. Keep the existing hair colour, and keep the beard exactly as it is.',
...
('cut-locks','Locks','cut',
 ...
 'Give the person dreadlocks: even cylindrical locs of shoulder length distributed over the whole head, neat parted roots. Keep the existing hair colour, and keep the beard exactly as it is.',
 '/demo/catalog/cut-locks.jpg', false, 120),

('cut-tresses','Tresses','cut',
 array['mi-long','raides','ondules','boucles','crepus','ovale','rond','carre','allonge','crepus','streetwear'],
 'Give the person braided hair: parallel cornrow braids laid flat along the scalp from the forehead to the nape, clean straight partings between them. Keep the existing hair colour, and keep the beard exactly as it is.',
...
('cut-cheveux-longs','Cheveux longs','cut',
 ...
 'Give the person long hair reaching well below the shoulders, worn loose with natural movement and a soft centre parting. Keep the existing hair colour, and keep the beard exactly as it is.',
...
('cut-long-attache','Cheveux longs attachés','cut',
 ...
 'Give the person long hair tied back into a bun at the back of the head, smooth pulled back lengths, clean hairline at the forehead. Keep the existing hair colour, and keep the beard exactly as it is.',
...
('cut-long-attache-boucle','Cheveux longs attachés bouclés','cut',
 ...
 'Give the person long curly hair tied back into a bun at the back of the head, curls visible around the hairline and in the bun. Keep the existing hair colour, and keep the beard exactly as it is.',
...
('beard-rase','Rasé de près','beard',
 ...
 'Remove the person''s facial hair completely: clean shaven face with smooth skin, no stubble. Keep the existing hairstyle, hair length and hair colour exactly as they are.',
 '/demo/catalog/beard-rase.jpg', false, 300),

('beard-trois-jours','Barbe de trois jours','beard',
 array['court','discret','moderne'],
 'Give the person light three day stubble evenly covering the jaw, chin and upper lip, short and natural. Keep the existing hairstyle, hair length and hair colour exactly as they are.',
 '/demo/catalog/beard-trois-jours.jpg', false, 310),

('beard-courte','Barbe courte taillée','beard',
 array['court','soigne','classique'],
 'Give the person a short trimmed beard: even short length along the jaw and chin, clean defined cheek line and neckline. Keep the existing hairstyle, hair length and hair colour exactly as they are.',
 '/demo/catalog/beard-courte.jpg', false, 320),

('beard-fournie','Barbe fournie','beard',
 array['mi-long','remarque','classique'],
 'Give the person a full thick beard covering the jaw, chin and cheeks, dense and well groomed, natural shape. Keep the existing hairstyle, hair length and hair colour exactly as they are.',
 '/demo/catalog/beard-fournie.jpg', false, 330),

('beard-longue','Barbe longue','beard',
 array['long','remarque'],
 'Give the person a long beard falling below the chin, dense and well groomed, natural shape and texture. Keep the existing hairstyle, hair length and hair colour exactly as they are.',
 '/demo/catalog/beard-longue.jpg', false, 340),

('beard-bouc','Bouc','beard',
 array['court','moderne'],
 'Give the person a goatee: hair on the chin only, cheeks and jaw clean shaven, neatly trimmed outline. Keep the existing hairstyle, hair length and hair colour exactly as they are.',
 '/demo/catalog/beard-bouc.jpg', false, 350),

('beard-moustache','Moustache','beard',
 array['court','remarque'],
 'Give the person a moustache only: hair on the upper lip, chin and cheeks completely clean shaven. Keep the existing hairstyle, hair length and hair colour exactly as they are.',
 '/demo/catalog/beard-moustache.jpg', false, 360),

('beard-bouc-moustache','Bouc et moustache','beard',
 array['court','moderne','soigne'],
 'Give the person a circle beard: a moustache joined to a chin goatee forming a closed circle around the mouth, cheeks clean shaven. Keep the existing hairstyle, hair length and hair colour exactly as they are.',
 '/demo/catalog/beard-bouc-moustache.jpg', false, 370),

('beard-collier','Barbe collier','beard',
 array['court','soigne'],
 'Give the person a chinstrap beard: a thin even line of beard following the jawline from ear to ear, cheeks and chin otherwise clean shaven. Keep the existing hairstyle, hair length and hair colour exactly as they are.',
